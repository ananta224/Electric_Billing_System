...
public class GenerateBill extends JFrame implements ActionListener, Printable {
    ...
    String meter;
    JButton bill;
    JButton printButton; // Add a print button
    Choice cmonth;
    JTextArea area;
    ...
    public GenerateBill(String meter) {
        ...
        area.setFont(new Font("Senserif", Font.ITALIC, 12));
        ...
        panel.add(cmonth);
        panel.add(printButton); // Add the print button
        add(panel, "North");
        add(pane, "Center");
        add(bill, "South");
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            area.setText("\tAnanta Power Limited\nELECTRICITY BILL GENERATED FOR THE MONTH\n\tOF "+month+", 2023\n\n\n");
